...
public class Appointment {
	...
	public String toString() {
		return "Appointment [bookId=" + bookId + ", doctorName=" + doctorName + ", patientName=" + patientName
				+ ", payment=" + payment + ", status=" + status + ", dateTime=" + dateTime + "]";
	}
